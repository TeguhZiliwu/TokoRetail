                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="tabs-detail">
                            <div class="row">
                                <div class="col-xl-6">
                                    <div class="mb-3">
                                        <label for="txtGroupID" class="form-label">Group ID <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control maintenance-form" id="txtGroupID" placeholder="Masukkan Group ID" autocomplete="off" maxlength="20">
                                    </div>

                                    <div class="mb-3">
                                        <label for="txtGroupDescription" class="form-label">Deskripsi Group <span class="text-danger">*</span></label>
                                        <textarea class="form-control maintenance-form" id="txtGroupDescription" rows="5" placeholder="Masukkan Deskripsi Group" autocomplete="off" maxlength="100"></textarea>
                                    </div>
                                </div> <!-- end col-->
                            </div>
                            <div class="row mt-1">
